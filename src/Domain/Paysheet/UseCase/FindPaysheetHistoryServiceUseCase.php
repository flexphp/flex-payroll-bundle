...
use FlexPHP\Bundle\PayrollBundle\Domain\Paysheet\Response\FindPaysheetHistoryServiceResponse;

final class FindPaysheetHistoryServiceUseCase
{
    ...
    public function execute(FindPaysheetHistoryServiceRequest $request)
    {
        $customers = $this->orderRepository->findHistoryServiceBy($request);

        return new FindPaysheetHistoryServiceResponse($customers);
    }
}
