...
use FlexPHP\Bundle\PayrollBundle\Domain\PayrollStatus\Response\ReadPayrollStatusResponse;

final class ReadPayrollStatusUseCase
{
    ...
    public function execute(ReadPayrollStatusRequest $request): ReadPayrollStatusResponse
    {
        $payrollStatus = $this->payrollStatusRepository->getById($request);

        return new ReadPayrollStatusResponse($payrollStatus);
    }
}
