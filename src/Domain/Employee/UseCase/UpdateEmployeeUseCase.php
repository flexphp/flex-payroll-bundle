...
use FlexPHP\Bundle\PayrollBundle\Domain\Employee\Response\UpdateEmployeeResponse;
...
final class UpdateEmployeeUseCase
{
    ...
    {
        return new UpdateEmployeeResponse($this->employeeRepository->change($request));
    }
}
