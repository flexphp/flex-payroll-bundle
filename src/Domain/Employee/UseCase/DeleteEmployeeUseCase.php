...
use FlexPHP\Bundle\PayrollBundle\Domain\Employee\Response\DeleteEmployeeResponse;
...
final class DeleteEmployeeUseCase
{
    ...
    public function execute(DeleteEmployeeRequest $request): DeleteEmployeeResponse
    {
        return new DeleteEmployeeResponse($this->employeeRepository->remove($request));
    }
}
