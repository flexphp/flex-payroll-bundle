...
use FlexPHP\Bundle\PayrollBundle\Domain\EmployeeType\Response\DeleteEmployeeTypeResponse;

final class DeleteEmployeeTypeUseCase
{
    ...
    public function execute(DeleteEmployeeTypeRequest $request): DeleteEmployeeTypeResponse
    {
        return new DeleteEmployeeTypeResponse($this->employeeTypeRepository->remove($request));
    }
}
