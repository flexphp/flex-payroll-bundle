...
use FlexPHP\Bundle\PayrollBundle\Domain\EmployeeType\Response\UpdateEmployeeTypeResponse;

final class UpdateEmployeeTypeUseCase
{
    ...
    public function execute(UpdateEmployeeTypeRequest $request): UpdateEmployeeTypeResponse
    {
        return new UpdateEmployeeTypeResponse($this->employeeTypeRepository->change($request));
    }
}
