...
use FlexPHP\Bundle\PayrollBundle\Domain\AgreementPeriod\Response\CreateAgreementPeriodResponse;

final class CreateAgreementPeriodUseCase
{
    ...
    public function execute(CreateAgreementPeriodRequest $request): CreateAgreementPeriodResponse
    {
        return new CreateAgreementPeriodResponse($this->agreementPeriodRepository->add($request));
    }
}
